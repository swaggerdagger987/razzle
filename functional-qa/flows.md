...
| 36 | Efficiency metrics | YPC, YPR, YPT calculated correctly from raw stats? Not showing NaN/Infinity for 0 attempts? | RE-AUDIT SESSION 37 — STILL BROKEN ON PROD. Code fix verified (dashboards.py:121-122 adds pass_attempts for QBs). Prod 2025: Dak opp=53, Mayfield 55, Mahomes 65 (all carries-only). `attempts` column exists in DB (Lamar 474). FUNC-035 + FUNC-036. |
