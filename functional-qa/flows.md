...
| 36 | Efficiency metrics | YPC, YPR, YPT calculated correctly from raw stats? Not showing NaN/Infinity for 0 attempts? | RE-AUDIT SESSION 64 — PARTIAL. Backend confirmed correct: all 8 grades (A+/A/B+/B/C+/C/D/F) produced by _grade_from_percentile across stock-watch, efficiency, report-card endpoints. Half-PPR verified (MCF 365.6 = (416.6+314.6)/2). IEEE 754 clean. FUNC-064 STILL OPEN: 5 frontend renderers don't handle B+/C+ grades (efficiency.html, consistency.html, schedule.html, stocks.html, lab-panels.js SOS). B+ renders as unstyled or RED. |
...
| 62 | Dashboard / Stat Leaders | Summary stats populated? Leaders match screener data? Category switching works? | RE-AUDIT SESSION 64 — PARTIAL. Backend all 8 grades confirmed (stock-watch verified A+/A/B+/B/C+/C/D/F with fresh server). Report cards: MCF GPA_pct=82 B+, Nacua GPA_pct=82 B+. Awards: 10 awards with sensible winners. FUNC-064 STILL OPEN: 5 frontend renderers don't handle B+/C+ grades. All Pro-gated so free users unaffected. |
