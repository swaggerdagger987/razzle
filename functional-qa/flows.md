...
| 36 | Efficiency metrics | YPC, YPR, YPT calculated correctly from raw stats? Not showing NaN/Infinity for 0 attempts? | RE-AUDIT SESSION 58 — PASS. Ship Loop position-specific opp thresholds in dashboards.py (efficiency: QB:50/RB:50/WR:40/TE:20), tools.py (td-regression: QB:20/RB:20/WR:15/TE:10), college.py (efficiency: QB:30/RB:25/WR:20/TE:15, stock: QB:25/RB:20/WR:15/TE:10). TE efficiency: 30 players returned (Tucker Kraft PPO=2.6 #1). College TE efficiency: 28 players (DJ Williams PPO=2.82 #1). Report cards: 25 honor roll TEs (Goedert A, Kelce B+). No NaN/Infinity. |
...
| 62 | Dashboard / Stat Leaders | Summary stats populated? Leaders match screener data? Category switching works? | RE-AUDIT SESSION 58 — FUNC-061/062 FIXED. Most Efficient: Boutte (WR, PPO=2.7, 14G, 8.86 PPG) — filter p["opportunities"]>=40 working (was Chism III 3 opps). P2: Boutte only 8.86 PPG, low-volume efficiency winner. Volume King: McCaffrey (RB) — filter p["position"]!="QB" working (was Bo Nix). Runners all RBs. NOTE: pycache must be cleared after Ship Loop merges or old bytecode runs. Redzone King still 0 GL TDs locally (PBP=0 rows). 0 JS errors. |
