...
| 36 | Efficiency metrics | YPC, YPR, YPT calculated correctly from raw stats? Not showing NaN/Infinity for 0 attempts? | RE-AUDIT SESSION 40 — FUNC-040 CODE FIX VERIFIED. ROUND(SUM(fantasy_points_*), 1) applied in _STAT_SUM_COLS (core.py:119-120) and inline HPPR (players.py:201,458). Prod still shows IEEE 754 artifacts (Nacua HPPR=310.49999999999994, JSN PPR=359.90000000000003). QB opp still broken on prod (Dak opp=53 carries-only). All fixes await deployment. |
