...
| 43 | VORP | Value over replacement calculated? Replacement level defined per position? Sensible? | RE-AUDIT SESSION 56 — PASS. VORP data verified clean: 50 league_winners, 25 replacement_level, 0 null PPG, 0 IEEE 754 artifacts. FUNC-060 (TE PPO nulls in stock-watch) still open — 14/19 rising TEs have null PPO. |
...
| 62 | Dashboard / Stat Leaders | Summary stats populated? Leaders match screener data? Category switching works? | RE-AUDIT SESSION 56 — FUNC-061/062 FILED. Awards endpoint: "Most Efficient" Efton Chism III (3 targets, 2.06 PPG, PPO=5.50) wins over elite WRs — no min opp threshold. "Volume King" all QBs — opp share formula mixes pass attempts vs team targets+carries. 5 of 10 awards reasonable (MVP/IronMan/Survivor/Dominator/Floor). Red Zone King meaningless (PBP=0 rows). 0 JS errors across 9 panels. |
