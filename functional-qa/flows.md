...
| 37 | Regression candidates | TD regression logic sound? Flagging high-TD players with low expected TDs? | RE-AUDIT SESSION 48 — FUNC-052 (P1). **Lab panel completely broken** — 4 field mismatches cause empty render: buy_low vs positive_regression, sell_high vs negative_regression, position_rates vs pos_avg_td_rates, p.diff vs p.td_diff. Standalone tdregression.html works correctly. API data verified correct (Stafford +16.5 sell, Ward -10.3 buy). |
