...
priority: P2
area: opportunity.html, reportcard.html, awards.html
section: player card rendering
type: visual hierarchy
status: open
---

# Apply card rank hierarchy to opportunity, reportcard, awards pages

**Files**: `frontend/opportunity.html`, `frontend/reportcard.html`, `frontend/awards.html`
