...
priority: P2
area: consistency.html
section: player card rendering
type: visual hierarchy
status: open
---

# Apply card rank hierarchy to consistency page

**File**: `frontend/consistency.html`

## What to do

In the consistency page JS rendering function, apply CSS classes from DES-210:
