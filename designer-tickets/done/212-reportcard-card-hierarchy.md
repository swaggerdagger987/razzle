...
priority: P2
area: reportcard.html
section: player card rendering
type: visual hierarchy
status: open
---

# Apply card rank hierarchy to reportcard page

**File**: `frontend/reportcard.html`

## What to do

In the reportcard page JS rendering function, apply CSS classes from DES-210:
