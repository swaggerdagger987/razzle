...
2026-05-30 | Closing an OG epic needs a hub wire, not another /og route — atom-2 (rankings/explore export) was already covered, so advance not rebuild | d6fc232 | keep | Marked atom-2 done (covered by generic /og/[panel] + /og/explore); shipped atom-3 hallway link instead; epic complete
