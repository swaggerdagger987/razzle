...
2026-05-30 | The screenshot flywheel breaks if the hub where people study a player cannot produce a card; default export must be free-tier | d6fc232 | keep | Player Sheet -> Lab export uses free dashboard panel + player caption; T3 hub now feeds T6 screenshots
