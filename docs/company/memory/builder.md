...
2026-05-31 | Lab OG demo rows — DEFAULT_DEMO_ROWS + slug overrides, isDemo flag, Satori blurb fix | PENDING_HASH | keep | Mirrors H2H demo pattern; removed loading-only empty state; Gate C curl 59KB PNG
