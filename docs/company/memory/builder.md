2026-05-31 | explore-og-margin-note-sticker | 64fff1115 | SHIP | LIVE · staff notes when live top-3 rows have margin notes.
2026-05-31 | explore-og-margin-note-rows | c1a0bcaad | SHIP | TOP_MARGIN_NOTE_ROWS=3 per-row margin on explore OG.
2026-05-31 | explore-og-margin-note-lead | 64fff1115 | SHIP | marginNoteForOgExploreRow + lead row on explore OG route.
...
2026-05-31 | lab-og-launch10-demo-blurbs | 3705fdce8 | SHIP | launch10Demo* helpers + pytest guard.
2026-05-31 | lab-og-from-panel-gate-c-rest | 64fff1115 | SHIP | prospects+tradevalues SNAPSHOT_FROM_PANEL_SLUGS; 5 pytest guards.
