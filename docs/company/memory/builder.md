...
2026-05-31 | H2H canonical codec | 64c762be | BureauH2HShareBar uses encodeBureauH2HOgSnapshot; OG route decodeBureauH2HOgSnapshot.
...
2026-05-31 | weekly-hot-week-og | ogSnapshotRows max week pts + Wk label | 64c762be | SHIP | KEEP hottest-week not PPG | — | — | evidence/2026-05-31-lab-weekly-hot-week-snapshot.md

2026-05-31 | bureau-h2h-snapshot-export | encodeBureauH2HOgSnapshot + BureauH2HShareBar ogSnapshot prop | 64c762be | SHIP | KEEP compact H2H snapshot lib | — | decode on OG route atom 3 | evidence/2026-05-31-bureau-h2h-snapshot-export.md
...
2026-05-31 | Bureau Monte Carlo copy link morning | 64c762be | keep | copyMonteCarloLink row; H2H dedup ShareBar on base; curl monte-carlo 53350B
...
2026-05-31 | league-build-profiles-tab | 64c762be | keep | BureauBuildProfiles Atlas archetype grid; unhide slug; build PASS pytest 51
2026-05-31 | league-strength-of-schedule-tab | 64c762be | keep | BureauStrengthOfSchedule; HIDDEN_BUREAU_SLUGS empty; epic 3/3
2026-05-31 | lab-og-breakouts-score-ranked | 64c762be | keep | BreakoutsRenderer RBS sort; curl 60649B; fidelity epic complete
