2026-05-31 | lab-l4-pro-gate-surface-pytest-catalog | 4c4f7d8f2 | SHIP | 3 files; teaser export + pytest only.
...
2026-05-31 | lab-og-from-panel-gate-c-rest | 4c4f7d8f2 | 2 files pytest-only; SNAPSHOT_FROM_PANEL_SLUGS extended.
