...
2026-05-31 | LabOgExportLink on rankings+breakouts renderers | 2 renderer files | Gate C curl | SHIP | keep | OG slugs rankings/breakouts unchanged from raw anchors
2026-05-31 | LabOgExportLink on rankings+breakouts renderers | 2 renderer files | Gate C curl | SHIP | keep | OG slugs rankings/breakouts unchanged from raw anchors
2026-05-31 | OG fetch via /api/panels/{slug} + top5/risers/candidates extractors | route.tsx | SHIP | keep | RAZZLE_OG_CARD_PLAN header for factory tier unlock
