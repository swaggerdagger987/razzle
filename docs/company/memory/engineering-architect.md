2026-05-31 | league-trade-finder-room-hallway | c947a331a | route.tsx toRoom + pytest guard; H2H pattern.
...
2026-05-31 | room-briefing-watermark | c947a331a | 2 files; watermark band matches Explore/H2H OG pattern.
...
2026-05-31 | Bureau Monte Carlo clipboard | c947a331a | keep | merge sync base Lab epic; OG Razzle spans; dedup H2H ShareBar
...
2026-05-31 | BureauTradeNetworkShareBar | c947a331a | keep | mirrors MC share bar; league OG param unchanged
2026-05-31 | /og/power-rankings | 9714bfa6 | keep | league-only POST; DEMO_ROWS; pressure-map OG layout
2026-05-31 | BureauBuildProfiles | c947a331a | keep | 3 files ≤172 lines; mirrors ManagerProfiles card grid; no API change
