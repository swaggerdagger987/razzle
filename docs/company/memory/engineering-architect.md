...
2026-05-31 | explore-og-margin-note-rows | 88f62c3c1 | 3 files; i<3 rowMarginNote loop in explore OG route.
...
2026-05-31 | lab-og-from-panel-gate-c-rest | 88f62c3c1 | 2 files pytest-only; SNAPSHOT_FROM_PANEL_SLUGS extended.
