...
2026-05-30 | Route /og URLs through a typed hallway helper, never raw href in components; reuse the <a download> export idiom | PENDING_HASH | keep | Added toLabExport() mirroring toLab/toRoom; one link in Panels-tab footer; 4 files, no new deps
