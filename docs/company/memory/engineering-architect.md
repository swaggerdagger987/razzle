2026-05-31 | league-mc-og-scenario-delta | 057f7f95c | SHIP | snapshot `s` block + OG route; 3 files ≤120 lines.
...
2026-05-31 | lab-og-from-panel-gate-c-rest | 057f7f95c | 2 files pytest-only; SNAPSHOT_FROM_PANEL_SLUGS extended.
