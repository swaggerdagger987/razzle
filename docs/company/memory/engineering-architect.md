...
2026-05-31 | explore-og-college-gate-c | df6ffb773 | SHIP | explore/route.tsx only; season=2024 fixture; Gate C pytest guard.
...
2026-05-31 | Bureau Monte Carlo clipboard | df6ffb773 | keep | merge sync base Lab epic; OG Razzle spans; dedup H2H ShareBar
...
2026-05-31 | BureauTradeNetworkShareBar | df6ffb773 | keep | mirrors MC share bar; league OG param unchanged
2026-05-31 | /og/power-rankings | 9714bfa6 | keep | league-only POST; DEMO_ROWS; pressure-map OG layout
2026-05-31 | BureauBuildProfiles | df6ffb773 | keep | 3 files ≤172 lines; mirrors ManagerProfiles card grid; no API change
