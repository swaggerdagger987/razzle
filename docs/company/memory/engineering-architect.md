2026-05-31 | lab-og-career-compare-live | 9a32bf547 | SHIP | 2-file contract; multi-fetch p1/p2/p3 capped at 3 players.
...
2026-05-31 | room-briefing-watermark | 9a32bf547 | 2 files; watermark band matches Explore/H2H OG pattern.
...
2026-05-31 | Bureau Monte Carlo clipboard | 9a32bf547 | keep | merge sync base Lab epic; OG Razzle spans; dedup H2H ShareBar
...
2026-05-31 | BureauTradeNetworkShareBar | 9a32bf547 | keep | mirrors MC share bar; league OG param unchanged
2026-05-31 | /og/power-rankings | 9714bfa6 | keep | league-only POST; DEMO_ROWS; pressure-map OG layout
2026-05-31 | BureauBuildProfiles | 9a32bf547 | keep | 3 files ≤172 lines; mirrors ManagerProfiles card grid; no API change
