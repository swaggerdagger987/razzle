...
2026-05-31 | SOS renderer uses API summary fields only | 3 files ≤200 lines | SHIP | keep | no API change; Octo bars from your_ppg/opponent_avg_ppg
...
2026-05-31 | BureauWaiverTendencies | f0515fd4 | keep | 3 files ≤195 lines; Hawkeye header; no API change
