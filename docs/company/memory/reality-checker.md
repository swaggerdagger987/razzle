...
2026-05-31 | lab-og-export-link-rankings-breakouts | curl rankings 59509B breakouts 60649B + build + pytest | PASS | renderer-only; OG unchanged | keep
2026-05-31 | lab-og-panels-api-live | curl rankings 59509B dashboard 60034B + build + pytest | PASS | demo fallback still valid without terminal.db | keep
