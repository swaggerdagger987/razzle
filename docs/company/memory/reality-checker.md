...
2026-05-31 | SOS tab unhide | build exit 0; pytest 51; HIDDEN_BUREAU_SLUGS empty grep | PASS | keep | docs/v2/evidence/2026-05-31-league-strength-of-schedule-tab.md
