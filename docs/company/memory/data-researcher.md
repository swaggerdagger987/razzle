...
2026-05-31 | no web scrape | export link beside Ask agent on rankings/breakouts | screenshot path | keep | Bureau-pattern footer trust
2026-05-31 | no web scrape | OG must match panel API path for trust | REDDIT-INTEL workday note | keep | live tape vs sample preview labeling
