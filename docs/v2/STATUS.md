...
**Last updated:** 2026-05-31 (factory cycle 153 — League Monte Carlo scenario delta on OG export)
...
| Focus pillar | League |
| Focus layer | L5 |
| Next slice | league-mc-sharebar-scenario-encode (Monte Carlo epic atom 2/3) |
| Last commit | `057f7f95c` |
