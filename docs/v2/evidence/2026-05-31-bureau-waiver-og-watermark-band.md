...
**Epic:** League L5 — Bureau advanced tabs OG watermark parity (atom 3/3 route band; pytest atom next)  
**Verdict:** PASS
...
**Verdict:** PASS — terracotta watermark band on waiver OG; demo archetype rows + FAAB bars visible.
