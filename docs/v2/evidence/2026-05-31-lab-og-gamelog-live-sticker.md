...
- `launch10LiveStickerLabel("gamelog")` → `LIVE · weeks PPR strip` (matches `extractGamelogWeekRows` FPTS strip).
- Deduped breakouts/rankings atoms already on base (`ad24a219`).
