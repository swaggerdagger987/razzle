...
`buildExploreShareQuery` + `ogSortForUniverse` centralize universe and college sort remapping in copy-link and export-card URLs (mirrors `/og/explore` route). College export button label reads "export college card".
