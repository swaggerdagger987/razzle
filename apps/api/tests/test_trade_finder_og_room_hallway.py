"""Trade Finder OG Bones Room hallway — hero deal ask link (L5 atom 3/3)."""
...
def test_trade_finder_og_bones_room_hallway():
    ...
    assert "bonesTradeFinderRoomQuestion" in text
    assert "panelSlug: \"trade-finder\"" in text
    assert "ask ${bones.name} about this deal" in text
