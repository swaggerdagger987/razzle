"""Pressure Map OG watermark — League hallway deep link + LIVE/SAMPLE stickers (L5 atom 2/4)."""
...
def test_pressure_map_og_watermark_hallway_band():
    ...
    assert "LIVE · Sleeper trade pressure" in text
    assert "SAMPLE · demo pressure rows" in text
