    ...
    usePlayer
      ? {
          player: {
            ...
            slug: opts.playerId,
            name: opts.leadName?.trim() || "Player",
            position: opts.leadPosition,
            team: opts.leadTeam,
          },
        }
      : undefined,
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ display: "flex", fontWeight: 700 }}>{`${labLink} · open in Lab`}</div>
