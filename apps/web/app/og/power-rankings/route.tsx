...
const DEMO_ROWS: PowerRow[] = [
  { rank: 1, team: "Dynasty Dukes", record: "9-4", ppg: 124.2, differential: 12.4, luck: 1.2 },
  { rank: 2, team: "Your Squad", record: "8-5", ppg: 118.4, differential: 6.3, luck: -0.4 },
  { rank: 3, team: "Rebuild FC", record: "5-8", ppg: 102.1, differential: -8.7, luck: 0.8 },
];
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                <div style={{ display: "flex", fontFamily: "Luckiest Guy", fontSize: 28 }}>
                  #{row.rank} {row.team.length > 20 ? `${row.team.slice(0, 18)}…` : row.team}
                </div>
                <div style={{ display: "flex", fontSize: 16, color: "#5c4a3d" }}>{row.record}</div>
              </div>
              <div style={{ display: "flex", gap: 20, marginBottom: 8, fontSize: 18 }}>
                <div style={{ display: "flex" }}>
                  <span style={{ color: "#8a7565" }}>PPG </span>
                  <span style={{ fontWeight: 700 }}>{row.ppg}</span>
                </div>
                <div style={{ display: "flex" }}>
                  <span style={{ color: "#8a7565" }}>diff </span>
                  <span style={{ fontWeight: 700, color: diffColor(row.differential) }}>
                    {row.differential > 0 ? "+" : ""}
                    {row.differential}
                  </span>
                </div>
                <div style={{ display: "flex" }}>
                  <span style={{ color: "#8a7565" }}>luck </span>
              ...
              >
                <div
                  style={{
                    display: "flex",
                    width: barWidth(row.differential),
                    background: diffColor(row.differential),
                  }}
                />
              </div>
            </div>
