...
function bonesTradeRoomQuestion(hero: BureauTradeFinderOgMatch): string {
...
export async function GET(req: Request) {
  ...
  const hasHero = Boolean(hero?.give?.name && hero?.get?.name);
  const bonesRoomPath = hasHero
    ? toRoom({
        agentId: "bones",
        question: bonesTradeRoomQuestion(hero!),
