...
/** Panels whose OG route needs player_id in the share URL (matches /og/[panel]/route.tsx). */
export const PLAYER_SCOPED_OG_SLUGS = new Set([
  "dynasty-comps",
  "gamelog",
  "percentiles",
  "career",
...
export function LabOgExportLink({
  ...
  const resolvedPlayerId =
    playerId || (PLAYER_SCOPED_OG_SLUGS.has(slug) ? DEFAULT_LAB_OG_PLAYER_ID : undefined);
