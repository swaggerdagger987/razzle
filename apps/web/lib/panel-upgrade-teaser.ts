...
const PITCH_BY_SLUG: Record<string, string> = {
  ...
  percentiles: "position-relative percentile ranks on every stat — see where they land vs peers",
  strengths: "top stat strengths and weaknesses vs positional peers — know what they do best",
